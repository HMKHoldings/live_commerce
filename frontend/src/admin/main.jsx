...
function Admin(){
  ...
  const pageDescription=view==='6:2'?'신규, 재구매, VIP 고객과 구매 행동을 한눈에 확인하세요.':view==='6:1'?'상품별 매출, 판매수량, 재고와 카테고리 현황을 한눈에 확인하세요.':view==='6:0'?'주문 데이터를 기준으로 기간별 매출과 주문 상태를 분석합니다.':'내용을 수정하고 저장하면 연결된 스토어에 반영됩니다.';

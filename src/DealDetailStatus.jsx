...
export default function DealDetailStatus({ deal, joined }) {
  ...
  return <section className="pd-deal-status" aria-label="공동구매 참여 현황">
    <div className="pd-deal-clock" role="timer" aria-live="off" aria-label="공동구매 남은 시간">
    ...
    <div className="pd-deal-count">
      <strong>{participants.toLocaleString("ko-KR")}명 참여중 <span>· {Number(percent.toFixed(1))}% 달성</span></strong>
